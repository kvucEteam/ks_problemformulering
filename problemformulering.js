...
function step_0_template(){
	...
	HTML += 			((jsonData.steps[stepNo].hasOwnProperty('instruction'))?'<div">'+instruction(jsonData.steps[stepNo].instruction):'')+'</div><div class="clear"></div>';
...
function step_1_template(){
	...
	// HTML += 			((jsonData.steps[stepNo].hasOwnProperty('instruction'))?'<div >'+instruction(jsonData.steps[stepNo].instruction + insertMasterExample()):'')+'</div><div class="clear"></div>'; 
	HTML += 			((jsonData.steps[stepNo].hasOwnProperty('instruction'))?'<div >'+instruction( '<span id="dynamicText"></span><span class="cursor">|</span>' +  insertMasterExample()):'')+'</div><div class="clear"></div>';  // + '<span id="dynamicText"></span><span class="cursor">|</span>' + 
	HTML += 			((jsonData.steps[stepNo].hasOwnProperty('explanation'))?explanation(jsonData.steps[stepNo].explanation):'');
...
function step_2_template(){
	...
	// HTML += 			((jsonData.steps[stepNo].hasOwnProperty('instruction'))?'<div >'+instruction('Du valgte nøgleproblemet <span class="e2 label label-default">' + keyProblem + '</span>. '+ jsonData.steps[stepNo].instruction + insertMasterExample()):'')+'</div><div class="clear"></div>';  // OLD 17-05-2016
	HTML += 			((jsonData.steps[stepNo].hasOwnProperty('instruction'))?'<div >'+instruction('Du valgte <span class="e1 label label-default">' + keyProblem + '</span> som dit overordnede emne. '+ '<span id="dynamicText"></span><span class="cursor">|</span>' + insertMasterExample()):'')+'</div><div class="clear"></div>';	// NEW 17-05-2016
	HTML += 			((jsonData.steps[stepNo].hasOwnProperty('explanation'))?explanation(jsonData.steps[stepNo].explanation):'');
...
function step_5_template(){
	...
	// HTML += 			((jsonData.steps[stepNo].hasOwnProperty('instruction'))?'<div >'+instruction('<span id="dynamicText"></span><span class="cursor">|</span>' + returnAudioMarkup(stepNo)):'')+'</div><div class="clear"></div>';
	HTML += 			((jsonData.steps[stepNo].hasOwnProperty('instruction'))?'<div >'+instruction('<span id="dynamicText"></span><span class="cursor">|</span>'+ insertMasterExample() ):'')+'</div><div class="clear"></div>';
	HTML += 			((jsonData.steps[stepNo].hasOwnProperty('explanation'))?explanation(jsonData.steps[stepNo].explanation):'');
...
function step_6_template(){
	...
	// HTML += 			((jsonData.steps[stepNo].hasOwnProperty('instruction'))?'<div >'+instruction(jsonData.steps[stepNo].instruction + returnAudioMarkup(stepNo)):'')+'</div><div class="clear"></div>';
	// HTML += 			((jsonData.steps[stepNo].hasOwnProperty('instruction'))?'<div >'+instruction('<span id="dynamicText"></span><span class="cursor">|</span>'):'')+'</div><div class="clear"></div>';
	HTML += 			((jsonData.steps[stepNo].hasOwnProperty('instruction'))?'<div >'+instruction(jsonData.steps[stepNo].instruction + insertMasterExample()):'')+'</div><div class="clear"></div>';
	HTML += 			((jsonData.steps[stepNo].hasOwnProperty('explanation'))?explanation(jsonData.steps[stepNo].explanation):'');
...
// 	// UserMsgBox("body", HTML);
// 	console.log("step_6_download - HTML: " + JSON.stringify(HTML));

// 	var converted = htmlDocx.asBlob(HTML);
//     console.log("step_6_download - converted: " + JSON.stringify(converted));
